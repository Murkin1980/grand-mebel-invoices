...
# Database: PostgreSQL on Zeabur, SQLite locally
...
# ЭЦП settings (local only, won't work on Zeabur)
esf_cert_path = os.environ.get('ESF_CERT_PATH', r'C:\Users\Мурат\OneDrive\Documents\Бизнес планы\OpenCode\invoice_app_v2\invoice_app_v2\Aa123456\GOST512_5338fd7a1ed3e2759acae8f7c40dd4db5c511ca6.p12')
if os.path.exists(esf_cert_path):
    app.config['ESF_CERT_PATH'] = esf_cert_path
